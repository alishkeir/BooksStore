...
class UploadImageComponent extends Component
{
    ...
    {
        $this->model = isset($this->modelId) ? Publisher::find($this->modelId) : null;
    ...
    {
        if ($this->multiple) {
            return view('publishers::components.uploadimages');
        }

        return view('publishers::components.uploadimage');
    }
