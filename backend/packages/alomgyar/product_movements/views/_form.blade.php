@isset($model)
<form action="{{route('product_movements.update', ['product_movement' => $model])}}" method="POST" enctype="multipart/form-data" id="form">
    @method('PUT')
@else
<form action="{{route('product_movements.store')}}" method="POST" enctype="multipart/form-data" id="form">
@endisset
    @csrf
    <div class="row">
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <livewire:product_movements::uploadimage
                                path="product_movements/covers/"
                                acceptedFiles="image"
                                fieldName="cover"
