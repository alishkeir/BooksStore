@isset($model)
<form action="{{route('authors.update', ['author' => $model])}}" method="POST" enctype="multipart/form-data" id="form">
    @method('PUT')
@else
<form action="{{route('authors.store')}}" method="POST" enctype="multipart/form-data" id="form">
@endisset
    @csrf
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="dropzone" data-type="author" data-url="{{url(route('fileupload'))}}">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-footer d-flex justify-content-between">
                    ...
                    @if($model->updated_at ?? false)<span class="text-muted text-right">Módosítva:  {{ $model->updated_at->diffForHumans() }}</span>@endif
                </div>
                @endif
            </div>
        </div>
