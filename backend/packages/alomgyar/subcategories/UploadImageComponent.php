...
class UploadImageComponent extends Component
{
    ...
    {
        $this->model = isset($this->modelId) ? Subcategory::find($this->modelId) : null;
    ...
    {
        if ($this->multiple) {
            return view('subcategories::components.uploadimages');
        }

        return view('subcategories::components.uploadimage');
    }
