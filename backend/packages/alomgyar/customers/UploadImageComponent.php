...
class UploadImageComponent extends Component
{
    ...
    {
        $this->model = isset($this->modelId) ? Customer::find($this->modelId) : null;
    ...
    {
        if ($this->multiple) {
            return view('customers::components.uploadimages');
        }

        return view('customers::components.uploadimage');
    }
