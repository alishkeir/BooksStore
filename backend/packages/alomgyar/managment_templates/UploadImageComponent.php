...
class UploadImageComponent extends Component
{
    ...
    {
        $this->model = isset($this->modelId) ? Managment_template::find($this->modelId) : null;
    ...
    {
        if ($this->multiple) {
            return view('managment_templates::components.uploadimages');
        }

        return view('managment_templates::components.uploadimage');
    }
