...
class PreparePaymentRequestModel extends BaseRequestModel
{
    ...
    public function __construct($requestId = null, $type = PaymentType::Immediate, $guestCheckoutAllowed = true, $allowedFundingSources = [FundingSourceType::All], $window = '00:30:00', $locale = 'hu-HU', $initiateRecurrence = false, $recurrenceId = null, $redirectUrl = null, $callbackUrl = null, $currency = Currency::HUF, $traceId = '')
    {
