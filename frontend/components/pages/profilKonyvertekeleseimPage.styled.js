...
export let ProfilKonyvertekeleseimPageComponent = styled.div``;
...
export let ListItemRating = styled.div`
  margin-bottom: 20px;
`;
...
export let RatingTitle = styled.div`
  font-weight: 600;
  font-size: 14px;
  margin-bottom: 5px;
`;

export let RatingStars = styled.div``;
