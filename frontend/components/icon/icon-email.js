...
export default function IconChevronRightSmall({ className, iconColor = '#E30613' }) {
  let idRef = useRef(uuid());
    ...
    <div className={className}>
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          fill={iconColor}
        />
        <mask id={`mask${idRef.current}`} style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="1" y="2" width="22" height="20">
          <path fillRule="evenodd" clipRule="evenodd" d="M1 2H22.4999V21.5H1V2Z" fill="white" />
        </mask>
        <g mask={`url(#mask${idRef.current})`}>
          <path
            fillRule="evenodd"
            clipRule="evenodd"
